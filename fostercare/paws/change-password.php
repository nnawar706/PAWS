...
if(isset($_POST['submit'])){
  $query = mysqli_query($con,"select password from users where password='".md5($_POST['cpass'])."' and id='".$_SESSION['id']."'");
  ...
  if($num>0){
    ...
    echo "<script>alert('Caution: Current password does not match.');</script>";
  }
}
?>
<!DOCTYPE html>
    ...
    <section id="contact" class="contact">
      ...
      <div class="container">
        ...
        <div class="row gy-5 gx-lg-5">
          ...
          <div class="col-lg-8">
            <form class="register-form" role="form" method="post" name="changepassword" onSubmit="return valid();">
  ...
  <script type="text/javascript">
    function valid() {
      if(document.changepassword.cpass.value == ""){
        alert("Caution: You have not entered your current password.");
        document.changepassword.cpass.focus();
        return false;
      }
      else if(document.changepassword.newpass.value == ""){
        alert("Caution: You have not entered a new password yet.");
        document.changepassword.newpass.focus();
        return false;
      }
      else if(document.changepassword.cnfpass.value == ""){
        alert("Caution: You have not confirmed your new password yet.");
        document.changepassword.cnfpass.focus();
        return false;
      }
      else if(document.changepassword.newpass.value != document.changepassword.cnfpass.value){
