								...
								<div class="module">
									...
									<div class="module-body table">
										...
										<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
											<thead>
												<tr><th>#</th><th>Name</th><th>Email</th><th>Contact</th><th>NID</th><th>Registered On</th></tr>
											</thead>
											<tbody>
												<?php
												$query1=mysqli_query($con,"select * from vets");
												$count=1;
												...
												<tr>
													...
													<td><?php echo htmlentities($row1['contact']);?></td>
													<td><?php echo htmlentities($row1['nid']);?></td>
													<td><?php echo htmlentities($row1['regTime']);?></td>
													<?php $count=$count+1; }?>
												</tr>
											</tbody>
										</table>
