...
<head>
  ...
  <title>PAWS - Find Pet Home</title>
								...
								<div class="module">
									...
									<div class="module-body table">
										...
										<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
											<thead>
												<tr><th>#</th><th>Applicant's Name</th><th>Pet Description</th><th>Applied On</th><th>Adopted By</th></tr>
											</thead>
											<tbody>
												<?php
												$query=mysqli_query($con,"select * from pethome");
												$count=1;
												...
												<tr>
													...
													<?php
													$uid=$row['uid'];
													$query1=mysqli_query($con,"select name from users where id='$uid'");
													...
													if(is_null($val)){
														?>
														<td>Not Adopted Yet.</td>
													<?php
													}
													else {
														$sql=mysqli_query($con,"select name from users where id='$val'");
