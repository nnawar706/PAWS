								...
								<div class="module">
									...
									<div class="module-body">
										...
										<form class="form-horizontal row-fluid" name="fosterapp" method="post">
											<?php
											$pet_id=intval($_GET['pet_id']);
											$query=mysqli_query($con,"select * from foster where id='$pet_id'");
											while($row=mysqli_fetch_array($query)){
											?>
											<div class="row">
												<div class="col-md-11 form-group" style="margin-left: 38px;">
													<label class="info-title" for="Admin Name">Comment</label>
													<input type="text" class="form-control unicase-form-control text-input" id="name" name="status" required="required">
												</div>
											</div>
