...
if(isset($_POST['submit'])){
	...
	$sql=mysqli_query($con,"update category set name='$category',description='$description' where id='$cat_id'");
	$_SESSION['msg']="Caution: The following category has been updated.";
}
?>
										...
										<form class="form-horizontal row-fluid" name="category" method="post">
											...
											<div class="row">
												<div class="col-md-11 form-group" style="margin-left: 38px;">
													...
													<input type="text" class="form-control unicase-form-control text-input" id="name" name="category" value="<?php echo  htmlentities($row['name']);?>" required="required">
												</div>
											</div>
											<div class="row">
												<div class="col-md-11 form-group" style="margin-left: 38px;">
													<label class="info-title" for="Admin Name">Description</label>
													<input type="text" class="form-control unicase-form-control text-input" id="name" name="description" value="<?php echo  htmlentities($row['description']);?>" required="required">
												</div>
											</div>
										    <?php } ?>
