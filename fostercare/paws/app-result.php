          ...
          ?>
           ...
           <?php } ?>
                	<table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-striped" width="100%">
                		<thead>
                			<tr><th>#</th><th>ID</th><th>Pet Name</th><th>Pet Type</th><th>Status</th><th>Applied On</th></tr>
                		</thead>
                		<tbody>
                			<?php
                			$query01=mysqli_query($con,"select * from pethome where uid='".$_SESSION['id']."'");
                			$count=1;
                        ...
                        <td><?php echo htmlentities($row01['time']);?></td>
                			</tr>
                			<?php $count=$count+1; } ?>
                		</tbody>
                	</table>
